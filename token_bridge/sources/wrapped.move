module token_bridge::wrapped {
    ...
    use cedra_framework::coin::{Self, Coin, MintCapability, BurnCapability, FreezeCapability};
    ...
    public(friend) fun init_wrapped_coin<CoinType>(
        ...
        // log2(10^10) ~ 33 bits of precision, which we cannot afford on Cedra
        ...
        let (burn_cap, freeze_cap, mint_cap)
            = coin::initialize<CoinType>(
                ...
                // take the first 10 characters of the symbol (maximum in cedra)
...
module token_bridge::wrapped_test {
    ...
    use cedra_framework::type_info::{type_of};
    ...
    public fun init_wrapped_token() {
        let chain = cedra_message::u16::from_u64(2);
