module token_bridge::complete_transfer {
    ...
    fun complete_transfer<CoinType>(transfer: &Transfer, fee_recipient: address) {
        ...
        cedra_account::deposit_coins(recipient, recipient_coins);
        cedra_account::deposit_coins(fee_recipient, fee_coins);
    }
...
module token_bridge::complete_transfer_test {
    ...
    fun init_my_token(admin: &signer, decimals: u8, amount: u64) {
        ...
        cedra_account::deposit_coins(signer::address_of(admin), coin::mint(amount, &mint_cap));
    ...
    #[expected_failure(abort_code = 65542, location = cedra_framework::coin)] // EINSUFFICIENT_BALANCE
