...
module nft_bridge::complete_transfer_test {
    ...
    #[expected_failure(abort_code = 524297, location = cedra_token::token)]
    public fun test_complete_transfer_wrapped_asset_twice(
        ...
        let recipient_signer2 = cedra_framework::account::create_account_for_test(recipient2);
    ...
    fun complete_transfer_native_helper(
        ...
        cedra_framework::cedra_account::create_account(signer::address_of(second_user));
